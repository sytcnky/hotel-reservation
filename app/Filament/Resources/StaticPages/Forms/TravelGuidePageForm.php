...
class TravelGuidePageForm
{
    public static function schema(): array
    {
        ...
        return [
            Section::make(__('admin.static_pages.pages.travel_guide.page_header'))
                ->schema([
                    $tabs('travel_guide_header_i18n', collect($locales)->mapWithKeys(function (string $loc) {
                        return [$loc => [
